...
[CustomEditor(typeof(DrivenHandVisual))]
[CanEditMultipleObjects]
public class DrivenHandVisualEditor : UnityEditor.Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        DrivenHandVisual visual = (DrivenHandVisual)target;
    ...
    private void InitializeSkeleton(DrivenHandVisual visual)
    {
    ...
    private void AutoMapJoints(DrivenHandVisual visual)
    {
        if (Hand == null)
        {
            InitializeSkeleton(visual);
    ...
    private string FbxBoneNameFromHandJointId(DrivenHandVisual visual, HandJointId handJointId)
    {
